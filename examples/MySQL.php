...
class MySQL extends Prototype implements \App\Common\Example\ExampleInterface {
	...
	public function getHTML($a = NULL)
	{
		...
		$examples[] = [
			"header" => "Join with all the different comparison formats. And OR",
			"query" => [
				"db" => "user_data",
				"table" => "search",
				"join" => [[
					...
					"table" => "service",
					"on" => [[
						"service_id" => ["user_data", "search", "service_id"],
						[
							"db" => ["user_data", "search", "source"],
							"metric" => ["user_data", "search", "metric"],
						],
					]],
				]],
				"where" => [
		...
		$examples[] = [
			"header" => "Building a view",
			"query" => [
				"table" => "form_group_form_field",
				"left_join" => [[
					"table" => "form_group",
					"on" => "form_group_id",
					"include_meta" => true,
